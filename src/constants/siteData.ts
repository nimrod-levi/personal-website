...
export const siteName: string = "Nimrod Levi"
export const siteTitle: string = "Welcome to My Personal Website"
export const siteDescription: string = "A showcase of my work, projects, and information"
...
export const heroHeading: string = "Hi, I'm"
export const heroSubheading: string = "Building beautiful software solutions"
...
export const themeToggleLightLabel: string = "Switch to dark mode"
export const themeToggleDarkLabel: string = "Switch to light mode"
